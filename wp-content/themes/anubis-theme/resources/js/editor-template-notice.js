wp.domReady(() => {
    ...
    const templatesMessages = {
        ...
        'templates/public-page.blade.php': 'Cette page est utilisée pour les pages publique. Elles peuvent être visiter par tous les utilisateurs sans être conntecté.',
